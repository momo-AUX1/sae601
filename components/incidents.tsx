...
export default function Incidents() {
    ...
    const categories = ["all", "Pollution", "Infrastructure", "Waste", "Energy", "Transportation"]
    ...
    if (isLoading) {
        return (
            <div className="flex items-center justify-center py-12">
                <div className="text-gray-800 font-medium">Chargement des incidents...</div>
            </div>
        )
    }
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
                <h1 className="text-3xl font-bold text-gray-800 mb-8 flex items-center gap-3">
                    ...
                    Incidents Communautaires ({filteredIncidents.length})
                </h1>
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-3">
                                            <span
                                                className={`px-3 py-1 text-sm font-semibold rounded-lg ${getCategoryColor(incident.categorie)}`}
                                            >
                                                {incident.categorie}
                                            </span>
                                            <span
